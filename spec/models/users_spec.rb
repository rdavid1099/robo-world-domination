...
RSpec.describe User, type: :model do
  ...
  it "is initialized with an email, password, avatar" do
    user = User.new(email: "dude@dude.com", password: "testing", avatar: "mypic.jpg")

    expect(user).to be_valid
  end

  it "is invalid if email not provided" do
    user = User.new(password: "testing", avatar: "mypic.jpg")
  ...
  it "is invalid if password not provided" do
    user = User.new(email: "dude@dude.com", avatar: "mypic.jpg")
  ...
  it "is invalid if invalid email is provided" do
    user = User.new(email: "dudedude.com", password: "testing", avatar: "mypic.jpg")
  ...
  it "provides default avatar source if image is not uploaded" do
    user = User.new(email: "dude@dude.com", password: "testing")
